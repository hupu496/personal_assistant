...
IFontDisp = Font
__all__ = [ 'OLE_TRISTATE', 'IFontEventsDisp', 'FONTBOLD', 'IPicture',
           'OLE_HANDLE', 'LoadPictureConstants', 'Unchecked',
           'Monochrome', 'Checked', 'OLE_YPOS_PIXELS', 'Picture',
           'FONTSIZE', 'FONTNAME', 'OLE_YSIZE_PIXELS',
           'OLE_XPOS_CONTAINER', 'Default', 'OLE_YPOS_HIMETRIC',
           'OLE_XSIZE_HIMETRIC', 'IPictureDisp', 'OLE_XPOS_PIXELS',
           'OLE_COLOR', 'StdFont', 'OLE_XPOS_HIMETRIC',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_CANCELBOOL', 'IFont',
           'OLE_YSIZE_CONTAINER', 'FontEvents', 'StdPicture', 'Color',
           'FONTITALIC', 'FONTUNDERSCORE', 'Gray', 'VgaColor',
           'OLE_XSIZE_PIXELS', 'OLE_XSIZE_CONTAINER',
           'FONTSTRIKETHROUGH', 'OLE_YPOS_CONTAINER',
           'OLE_OPTEXCLUSIVE', 'IFontDisp', 'OLE_YSIZE_HIMETRIC',
           'Font']
